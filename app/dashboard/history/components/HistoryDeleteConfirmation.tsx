...
export default function HistoryDeleteConfirmation({ isOpen, onClose, onConfirm }: HistoryDeleteConfirmationProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={handleBackdropClick}>
            <div className="w-[400px] flex flex-col items-start p-6 gap-6 rounded-2xl border border-[#DEE0E3] bg-white shadow-[0px_10px_16px_-3px_rgba(20,21,26,0.08),0px_3px_6px_-2px_rgba(20,21,26,0.05)]">
                <div className="flex justify-between items-start w-full">
                    <div className="flex flex-col gap-1">
                        <h2 className="text-[#14151A] font-inter text-[18px] font-medium leading-[26px] tracking-[-0.216px]">
                            Delete summarized text?
                        </h2>
                        <p className="text-[rgba(15,19,36,0.60)] font-inter text-[16px] font-normal leading-[24px] tracking-[-0.16px]">

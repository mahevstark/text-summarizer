  ...
  return (
    <div className="bg-white rounded-lg max-w-login-container w-[calc(100%-2rem)] mx-4 p-4 xs:p-6 sm:p-10 flex flex-col items-center border border-bordercolor animate-fadeIn">
      <Image
        ...
        height={60}
        priority
        className="w-[40px] h-[40px] xs:w-[50px] xs:h-[50px] sm:w-[76px] sm:h-[76px] animate-scaleIn hover:scale-105 transition-transform duration-300"
      />
      <h2 className="text-base xs:text-lg sm:text-xl font-medium text-textbase font-inter tracking-heading mt-2 text-center animate-fadeIn">Log in to Undetectable AI</h2>
      <p className="text-xs xs:text-sm sm:text-base text-textsecondary font-inter mt-2 tracking-subheading leading-4 xs:leading-5 sm:leading-6 text-center px-2 animate-fadeIn opacity-0 animation-delay-200">Enter your username and password to continue</p>
